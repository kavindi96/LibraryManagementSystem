...
public class LibraryIO {
    ...
    public static void saveUserListToFile(List<User>users,String fileNme){
        try(ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(fileNme))){
    ...
    public static void saveBorrowedItemsToFile(
            Map<String,String> borrowedItems, String fileNme
    ){
        try(ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(fileNme))){
    ...
    public static Map<String,String> loadBorrowedItemsFromFiles(String fileName){
        File file = new File(fileName);
        if (!file.exists()){
